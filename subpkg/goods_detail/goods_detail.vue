<template>
  <view>
    <!-- 轮播图 -->
    <swiper indicator-dots autoplay duration="1500">
    ...
    <view class="goods_nav">
      <uni-goods-nav fill :buttonGroup="buttonGroup" :options="options" @click="optionClick" @buttonClick="buttonClick"></uni-goods-nav>
    </view>
  </view>
</template>
